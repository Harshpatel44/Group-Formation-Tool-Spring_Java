...
public class HomeController implements IHomeController{
	...
	/*
    @GetMapping("/home")
    public ModelAndView listcourse(@RequestParam(name="courseId") String courseId) {
    	user.setUserId("B00123456");
		...
		modelview.addObject("homeService", homeService.checkRole("B00123456", "hjak"));
		modelview.addObject("userId","B00123456");
		return modelview;
	}*/
//
